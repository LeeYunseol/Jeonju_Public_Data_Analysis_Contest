...
농협아중지점 - 4565, 만성에코르아파트후문 - 2415, 송천1동 솔내고앞 - 2618, 송천1동 오송중앞 - 3886,
...
'''
#%%
temp_df.loc[temp_df['법정동'] == '인후동1가', '단속수'] = temp_df.loc[temp_df['법정동'] == '인후동1가', '단속수'] + 4565
temp_df.loc[temp_df['법정동'] == '만성동', '단속수'] = temp_df.loc[temp_df['법정동'] == '만성동', '단속수'] + 2415
temp_df.loc[temp_df['법정동'] == '송천동1가', '단속수'] = temp_df.loc[temp_df['법정동'] == '송천동1가', '단속수'] + 2618+3886
temp_df.loc[temp_df['법정동'] == '송천동2가', '단속수'] = temp_df.loc[temp_df['법정동'] == '송천동2가', '단속수'] + 1506
temp_df.loc[temp_df['법정동'] == '여의동2가', '단속수'] = temp_df.loc[temp_df['법정동'] == '여의동2가', '단속수'] + 1254
#%%
# 데이터프레임으로 저장
temp_df.to_csv('모든시간 덕진구 고정식CCTV 단속현황.csv', index = False, encoding = 'CP949')
