...
data_dukjin = data.loc[(data['단속구분'] == "고정식CCTV") & (data['구청구분'] == "덕진구"), :]
data_dukjin_place = data_dukjin['단속장소명'].value_counts()
#%%
# 주변 도로 확인
data_cctv_move = data.loc[(data['단속구분'] == "이동식CCTV") & (data['구청구분'] == "덕진구"), :]
...
q4 = data_dukjin_place.quantile(0.75) # 515.75 => 롯데마트 주차장 입구 or 모래내시장 주차장입구
num = 0
